...
{
	$query .= 'ORDER BY EmployeeName DESC ';
}
...
foreach($result as $row)
{
	...
	$sub_array[] = '<button type="button" name="delete" id="'.$row["id_employe"].'" class="btn btn-danger btn-xs delete" data-status="'.$row["user_status"].'">Delete</button>';
	$data[] = $sub_array;
}

			...
			<div class="panel panel-default">
                <div class="panel-heading">
                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-6">
                        <div class="row">
                            <h3 class="panel-title">قائمة الأقسام</h3>
                        </div>
                    </div>
...
$(document).ready(function(){
	...
	$(document).on('submit','#category_form', function(event){
		...
		$.ajax({
			url:"Model/st_statistical_data/st_statistical_system_action.php",
			method:"POST",
			data:form_data,
	...
	$(document).on('click', '.update', function(){
		...
		$.ajax({
			...
			success:function(data)
			{
				...
				$('#category_name').val(data.Department);
	...
	var categorydataTable = $('#category_data').DataTable({
		...
		"order":[],
		"ajax":{
			url:"Model/st_statistical_data/st_statistical_system_fetch.php",
			type:"POST"
		},
		"columnDefs":[
			{
